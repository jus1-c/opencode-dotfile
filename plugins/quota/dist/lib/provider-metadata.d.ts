...
export type QuotaProviderAuthentication = "opencode_auth_oauth_token" | "opencode_auth_api_key" | "opencode_auth_metadata_token" | "companion_auth_oauth_token" | "local_cli_auth" | "github_oauth_or_pat" | "external_api_key" | "state_only";
...
declare const PROVIDER_CATALOG_SOURCE: {
    ...
    readonly llmgate: {
        readonly label: "LLMGate";
        readonly runtimeIds: readonly ["llmgate"];
        readonly synonyms: readonly ["llm-gate"];
        readonly shape: {
            readonly autoSetup: "yes";
            readonly authentication: "opencode_auth_oauth_token";
            readonly quota: "remote_api";
            readonly notes: "separate provider caches gateway credential in OS keychain and stores access/refresh tokens in OpenCode auth metadata";
        };
    };
    readonly vilao: {
        readonly label: "Vilao";
        readonly runtimeIds: readonly ["vilao"];
        readonly synonyms: readonly [];
        readonly shape: {
            readonly autoSetup: "needs_quick_setup";
            readonly authentication: "opencode_auth_metadata_token";
            readonly quota: "remote_api";
            readonly quickSetupAnchor: "vilao";
            readonly notes: "pay-as-you-go balance relative to the highest locally observed balance";
        };
    };
    readonly xai: {
        readonly label: "xAI";
    ...
    readonly "opencode-go": {
        ...
        readonly shape: {
            ...
            readonly authentication: "state_only";
            readonly quota: "remote_api";
            readonly quickSetupAnchor: "opencode-go";
            readonly notes: "Scrapes the OpenCode Go dashboard; requires workspaceId and authCookie";
        };
    };
    readonly opencode: {
